...
const slides = [
    {
        ...
        subtitle: 'Комплексний підхід до агробізнесу, тваринництва, садівництва та м’ясопереробки. «Чайка» – це торгова марка, якій довіряють споживачі, адже знають, що наша продукція створена з натуральних інгредієнтів.',
    },
];
